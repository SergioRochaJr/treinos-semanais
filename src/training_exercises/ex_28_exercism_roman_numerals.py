...
def roman_numeral(number: int) -> str:
    ...
    This function takes an integer between 1 and 3999 and converts it to its
    Roman numeral representation using the standard Roman numeral rules,
    including subtractive notation for numbers like 4 (IV), 9 (IX), etc.

    Args:
        number (int): The Arabic numeral to convert. Must be between 1 and 3999.
